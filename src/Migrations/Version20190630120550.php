...
final class Version20190630120550 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, wins INT DEFAULT NULL, wins_after_extra_time INT DEFAULT NULL, draws INT DEFAULT NULL, loses INT DEFAULT NULL, description VARCHAR(255) NOT NULL, crest LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\', photo LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
